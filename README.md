...
To setup and build the add-on from source, try to run `make` or `make all_in_docker`. Please see the [wiki](https://github.com/MikkCZ/pontoon-addon/wiki/Technical-Overview) for more detailed info.
